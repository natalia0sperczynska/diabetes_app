...
class AnalysisContent extends StatelessWidget {
        ...
        SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              _buildSectionTitle("ACHIEVEMENTS", context),
              _buildBestDayWidget(context, vm),
              const SizedBox(height: 24),
              _buildSectionTitle("AI DIAGNOSTIC", context),
  ...
  _buildBestDayWidget(BuildContext context, AnalysisViewModel vm){
